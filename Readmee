...
The project showes distribution between genders of customers who visit hospitals for different diseases. Whereeas the relationship between tables gives us the opportunity to filter customers by their age group, country, disease and counts of visits, also We can percieve workload of the hospitals between cities and revenues generated by each entity. 
